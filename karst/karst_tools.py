...
def check_cadastral_karst(
    ...
    try:
        ...
        print(f"❌ Error during karst analysis: {str(e)}")
        return error_result
...
def check_multiple_cadastrals_karst(
    ...
    try:
        ...
        print(f"💾 Batch karst analysis data saved to: {batch_karst_data_file}")
        ...
        print(f"✅ Batch karst analysis completed for {len(cadastral_numbers)} cadastrals")
        print(f"📁 All files saved to project directory: {project_dir}")
        ...
        print(f"❌ Error during batch karst analysis: {str(e)}")
        return error_result
...
def find_nearest_karst(
    ...
    try:
        ...
        print(f"💾 Nearest karst search data saved to: {nearest_karst_data_file}")
        ...
        print(f"✅ Nearest karst search completed for cadastral {cadastral_number}")
        print(f"📁 All files saved to project directory: {project_dir}")
        ...
        print(f"❌ Error during nearest karst search: {str(e)}")
        return error_result
...
def analyze_cadastral_karst_proximity(
    ...
    try:
        ...
        print(f"💾 Proximity analysis data saved to: {proximity_analysis_data_file}")
        ...
        print(f"✅ Comprehensive karst proximity analysis completed for {len(cadastral_numbers)} cadastrals")
        print(f"📁 All files saved to project directory: {project_dir}")
