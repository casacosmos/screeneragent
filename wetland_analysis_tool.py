...
def analyze_wetland_location_with_map(longitude: float, latitude: float, location_name: Optional[str] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        # Save detailed results to project logs directory
        ...
        # Save summary data to project data directory
...
def _generate_adaptive_map(longitude: float, latitude: float, location_name: str,
                          ...
                          map_generator: WetlandMapGeneratorV3, output_manager) -> Dict[str, Any]:
    ...
    try:
        ...
        map_filename = os.path.join(maps_dir, f"wetland_map_{safe_name}_{timestamp}.pdf")
        ...
        if map_path and map_path != map_filename:
            import shutil
            try:
